#!/bin/bash
DEFAULT_HADOOP_HOME=/home/spasic/hadoop-2.6.0 #change to your hadoop folder
DEFAULT_LDBC_SNB_DATAGEN_HOME=/home/spasic/work/hobbit/hobbit_snb_datagen #change to your ldbc_socialnet_dbgen folder
